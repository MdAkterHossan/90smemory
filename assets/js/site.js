// JavaScript Document
	...
	function validateHeadingTop(frmn,id, fnc){
		frm = document.getElementById(frmn);
		msg_pref="Please Complete the fields below:<br>";
		msg="";
		
		if(frm.elements["webTopHeadingOne"].value=="")  msg=msg+" - Heading Top field is blank<br>";
		if(frm.elements["webTopHeadingTwo"].value=="")  msg=msg+" - Heading Second field is blank<br>";
	...
	function validateMidHeading(frmn,id, fnc){
		frm = document.getElementById(frmn);
		msg_pref="Please Complete the fields below:<br>";
		msg="";
		
		if(frm.elements["midSectionOne"].value=="")  msg=msg+" - Mid Section field is blank<br>";
		if(frm.elements["midSectionTwo"].value=="")  msg=msg+" - Mid Second field is blank<br>";
	...
	function validateContact(frmn,id, fnc){
		frm = document.getElementById(frmn);
		msg_pref="Please Complete the fields below:<br>";
		msg="";
		
		if(frm.elements["contactHeadingOne"].value=="")  msg=msg+" - Contact Heading field is blank<br>";
		if(frm.elements["contactHeadingTwo"].value=="")  msg=msg+" - Contact Heading two field is blank<br>";
		if(frm.elements["contactNumber"].value=="")  msg=msg+" - Contact Number field is blank<br>";
		if(frm.elements["contactEmail"].value=="")  msg=msg+" - Contact Email field is blank<br>";
	...
	function validateFooterInfo(frmn,id, fnc){
		frm = document.getElementById(frmn);
		msg_pref="Please Complete the fields below:<br>";
		msg="";
		
		if(frm.elements["copyrightinfo"].value=="")  msg=msg+" - Copyright Info field is blank<br>";
		if(frm.elements["developerInfo"].value=="")  msg=msg+" - Developer Info two field is blank<br>";
		if(frm.elements["developerContact"].value=="")  msg=msg+" - Developer Contact field is blank<br>";
	...
	function validateAdmin(frmn,id, fnc){
		frm = document.getElementById(frmn);
		msg_pref="Please Complete the fields below:<br>";
		msg="";
		
		if(frm.elements["adminName"].value=="")  msg=msg+"      - Name field is blank<br>";
		if(frm.elements["adminAddress"].value=="")  msg=msg+"   - Address field is blank<br>";
		if(frm.elements["regDate"].value=="")  msg=msg+" 		- date field is blank<br>";
		if(frm.elements["adminPhone"].value=="")  msg=msg+"     - Phone field is blank<br>";
		if(frm.elements["adminPass"].value=="")  msg=msg+"      - Password field is blank<br>";
