...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?=base_url()?>adminAssets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Theme style -->
...
<!-- OPTIONAL SCRIPTS -->
<script src="<?=base_url()?>adminAssets/dist/js/demo.js"></script>

<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="<?=base_url()?>adminAssets/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="<?=base_url()?>adminAssets/plugins/raphael/raphael.min.js"></script>
<script src="<?=base_url()?>adminAssets/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="<?=base_url()?>adminAssets/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="<?=base_url()?>adminAssets/plugins/chart.js/Chart.min.js"></script>

<!-- PAGE SCRIPTS -->
<script src="<?=base_url()?>adminAssets/dist/js/pages/dashboard2.js"></script>
